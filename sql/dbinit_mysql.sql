...
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (1,'Filter::SNMP','return $1->isSNMP;' '\r\n');
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (2,'Filter::Agent','return $1->isAgent;' '\r\n');
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (3,'Filter::AgentOrSNMP','return $1->isAgent || $1->isSNMP;' '\r\n');
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (4,'DCI::SampleTransform','sub dci_transform()' '\r\n' '{' '\r\n' '   return $1 + 1;' '\r\n' '}' '\r\n');
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (11,'Hook::StatusPoll','/* Available global variables:' '\r\n' ' *  $node - current node, object of ''Node'' type' '\r\n' ' *' '\r\n' ' * Expected return value:' '\r\n' ' *  none - returned value is ignored' '\r\n' ' */' '\r\n');
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (12,'Hook::ConfigurationPoll','/* Available global variables:' '\r\n' ' *  $node - current node, object of ''Node'' type' '\r\n' ' *' '\r\n' ' * Expected return value:' '\r\n' ' *  none - returned value is ignored' '\r\n' ' */' '\r\n');
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (13,'Hook::InstancePoll','/* Available global variables:' '\r\n' ' *  $node - current node, object of ''Node'' type' '\r\n' ' *' '\r\n' ' * Expected return value:' '\r\n' ' *  none - returned value is ignored' '\r\n' ' */' '\r\n');
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (14,'Hook::TopologyPoll','/* Available global variables:' '\r\n' ' *  $node - current node, object of ''Node'' type' '\r\n' ' *' '\r\n' ' * Expected return value:' '\r\n' ' *  none - returned value is ignored' '\r\n' ' */' '\r\n');
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (15,'Hook::CreateInterface','/* Available global variables:' '\r\n' ' *  $node - current node, object of ''Node'' type' '\r\n' ' *  $1 - current interface, object of ''Interface'' type' '\r\n' ' *' '\r\n' ' * Expected return value:' '\r\n' ' *  true/false - boolean - whether interface should be created' '\r\n' ' */' '\r\n' 'return true;' '\r\n');
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (16,'Hook::AcceptNewNode','/* Available global variables:' '\r\n' ' *  $ipAddr - IP address of the node being processed' '\r\n' ' *  $ipNetMask - netmask of the node being processed' '\r\n' ' *  $macAddr - MAC address of the node being processed' '\r\n' ' *  $zoneId - zone ID of the node being processed' '\r\n' ' *' '\r\n' ' * Expected return value:' '\r\n' ' *  true/false - boolean - whether node should be created' '\r\n' ' */' '\r\n' 'return true;' '\r\n');
