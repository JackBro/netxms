...
INSERT INTO event_cfg (event_code,event_name,guid,severity,flags,message,description) VALUES
 (
  ...
  'Parameters:' || char(13,10) ||
  '   1) Parameter name' || char(13,10) || '   2) Item description' || char(13,10) || '   3) Threshold value' || char(13,10) || '   4) Actual value' || char(13,10) || '   5) Data collection item ID' || char(13,10) || '   6) Instance' || char(13,10) || '   7) Repeat flag'
 );
INSERT INTO event_cfg (event_code,event_name,guid,severity,flags,message,description) VALUES
 (
...
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (1,'Filter::SNMP','return $1->isSNMP;' || char(13,10));
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (2,'Filter::Agent','return $1->isAgent;' || char(13,10));
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (3,'Filter::AgentOrSNMP','return $1->isAgent || $1->isSNMP;' || char(13,10));
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (4,'DCI::SampleTransform','sub dci_transform()' || char(13,10) || '{' || char(13,10) || '   return $1 + 1;' || char(13,10) || '}' || char(13,10));
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (11,'Hook::StatusPoll','/* Available global variables:' || char(13,10) || ' *  $node - current node, object of ''Node'' type' || char(13,10) || ' *' || char(13,10) || ' * Expected return value:' || char(13,10) || ' *  none - returned value is ignored' || char(13,10) || ' */' || char(13,10));
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (12,'Hook::ConfigurationPoll','/* Available global variables:' || char(13,10) || ' *  $node - current node, object of ''Node'' type' || char(13,10) || ' *' || char(13,10) || ' * Expected return value:' || char(13,10) || ' *  none - returned value is ignored' || char(13,10) || ' */' || char(13,10));
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (13,'Hook::InstancePoll','/* Available global variables:' || char(13,10) || ' *  $node - current node, object of ''Node'' type' || char(13,10) || ' *' || char(13,10) || ' * Expected return value:' || char(13,10) || ' *  none - returned value is ignored' || char(13,10) || ' */' || char(13,10));
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (14,'Hook::TopologyPoll','/* Available global variables:' || char(13,10) || ' *  $node - current node, object of ''Node'' type' || char(13,10) || ' *' || char(13,10) || ' * Expected return value:' || char(13,10) || ' *  none - returned value is ignored' || char(13,10) || ' */' || char(13,10));
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (15,'Hook::CreateInterface','/* Available global variables:' || char(13,10) || ' *  $node - current node, object of ''Node'' type' || char(13,10) || ' *  $1 - current interface, object of ''Interface'' type' || char(13,10) || ' *' || char(13,10) || ' * Expected return value:' || char(13,10) || ' *  true/false - boolean - whether interface should be created' || char(13,10) || ' */' || char(13,10) || 'return true;' || char(13,10));
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (16,'Hook::AcceptNewNode','/* Available global variables:' || char(13,10) || ' *  $ipAddr - IP address of the node being processed' || char(13,10) || ' *  $ipNetMask - netmask of the node being processed' || char(13,10) || ' *  $macAddr - MAC address of the node being processed' || char(13,10) || ' *  $zoneId - zone ID of the node being processed' || char(13,10) || ' *' || char(13,10) || ' * Expected return value:' || char(13,10) || ' *  true/false - boolean - whether node should be created' || char(13,10) || ' */' || char(13,10) || 'return true;' || char(13,10));
