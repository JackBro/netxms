...
INSERT INTO event_cfg (event_code,event_name,guid,severity,flags,message,description) VALUES
 (
  ...
  'Parameters:' || chr(13)||chr(10) ||
  '   1) Parameter name' || chr(13)||chr(10) || '   2) Item description' || chr(13)||chr(10) || '   3) Threshold value' || chr(13)||chr(10) || '   4) Actual value' || chr(13)||chr(10) || '   5) Data collection item ID' || chr(13)||chr(10) || '   6) Instance' || chr(13)||chr(10) || '   7) Repeat flag'
 );
INSERT INTO event_cfg (event_code,event_name,guid,severity,flags,message,description) VALUES
 (
...
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (1,'Filter::SNMP','return $1->isSNMP;' || chr(13)||chr(10));
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (2,'Filter::Agent','return $1->isAgent;' || chr(13)||chr(10));
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (3,'Filter::AgentOrSNMP','return $1->isAgent || $1->isSNMP;' || chr(13)||chr(10));
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (4,'DCI::SampleTransform','sub dci_transform()' || chr(13)||chr(10) || '{' || chr(13)||chr(10) || '   return $1 + 1;' || chr(13)||chr(10) || '}' || chr(13)||chr(10));
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (11,'Hook::StatusPoll','/* Available global variables:' || chr(13)||chr(10) || ' *  $node - current node, object of ''Node'' type' || chr(13)||chr(10) || ' *' || chr(13)||chr(10) || ' * Expected return value:' || chr(13)||chr(10) || ' *  none - returned value is ignored' || chr(13)||chr(10) || ' */' || chr(13)||chr(10));
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (12,'Hook::ConfigurationPoll','/* Available global variables:' || chr(13)||chr(10) || ' *  $node - current node, object of ''Node'' type' || chr(13)||chr(10) || ' *' || chr(13)||chr(10) || ' * Expected return value:' || chr(13)||chr(10) || ' *  none - returned value is ignored' || chr(13)||chr(10) || ' */' || chr(13)||chr(10));
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (13,'Hook::InstancePoll','/* Available global variables:' || chr(13)||chr(10) || ' *  $node - current node, object of ''Node'' type' || chr(13)||chr(10) || ' *' || chr(13)||chr(10) || ' * Expected return value:' || chr(13)||chr(10) || ' *  none - returned value is ignored' || chr(13)||chr(10) || ' */' || chr(13)||chr(10));
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (14,'Hook::TopologyPoll','/* Available global variables:' || chr(13)||chr(10) || ' *  $node - current node, object of ''Node'' type' || chr(13)||chr(10) || ' *' || chr(13)||chr(10) || ' * Expected return value:' || chr(13)||chr(10) || ' *  none - returned value is ignored' || chr(13)||chr(10) || ' */' || chr(13)||chr(10));
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (15,'Hook::CreateInterface','/* Available global variables:' || chr(13)||chr(10) || ' *  $node - current node, object of ''Node'' type' || chr(13)||chr(10) || ' *  $1 - current interface, object of ''Interface'' type' || chr(13)||chr(10) || ' *' || chr(13)||chr(10) || ' * Expected return value:' || chr(13)||chr(10) || ' *  true/false - boolean - whether interface should be created' || chr(13)||chr(10) || ' */' || chr(13)||chr(10) || 'return true;' || chr(13)||chr(10));
INSERT INTO script_library (script_id,script_name,script_code)
 VALUES (16,'Hook::AcceptNewNode','/* Available global variables:' || chr(13)||chr(10) || ' *  $ipAddr - IP address of the node being processed' || chr(13)||chr(10) || ' *  $ipNetMask - netmask of the node being processed' || chr(13)||chr(10) || ' *  $macAddr - MAC address of the node being processed' || chr(13)||chr(10) || ' *  $zoneId - zone ID of the node being processed' || chr(13)||chr(10) || ' *' || chr(13)||chr(10) || ' * Expected return value:' || chr(13)||chr(10) || ' *  true/false - boolean - whether node should be created' || chr(13)||chr(10) || ' */' || chr(13)||chr(10) || 'return true;' || chr(13)||chr(10));
